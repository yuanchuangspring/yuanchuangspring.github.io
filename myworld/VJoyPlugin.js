...
var Joystick = new Phaser.Class({
    ...
    onKeyDown: function (pointer)
    {
        ...
        posx=sw/2+(pointer.x-sw/2)/this.zoom;
        posy=sh/2+(pointer.y-sh/2)/this.zoom;
    ...
    preUpdate: function (time, delta)
    {
        ...
        var deltaY = sh/2+(pointer.y-sh/2)/this.zoom - this.y;
